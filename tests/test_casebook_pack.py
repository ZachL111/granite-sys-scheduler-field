"""Regression checks for the granite-sys-scheduler-field casebook."""
...
from casebook.harness import assert_expected, granite_sys_scheduler_field_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_sys_scheduler_field_summary(), assert_expected())
